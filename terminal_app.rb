...
def note_app
    ...
    puts "(options: quicknote, make file, make directory, move file, remove file, remove directory)".colorize(:light_cyan).underline
    ...
    while user_input
        ...
        if user_input == "quicknote" || user_input == "q"
            ...
            puts "what file would you like to remove(have to add .txt to end of choice)".colorize(:light_green).underline
